        ...
        <div class="p-4 text-white">
            ...
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist">
                ...
                <div class="collapse" id="collapseDonThuoc">
                    <div class="bg-white text-dark rounded ms-4 me-3">
                        <a class="dropdown-item py-2" href="#">Đơn chờ duyệt</a>
                        <a class="dropdown-item py-2" href="#">Đơn đã duyệt</a>
                        <a class="dropdown-item py-2" href="#">Đơn bị hủy</a>
                        <a class="dropdown-item py-2" href="#">Lịch sử đơn thuốc</a>
                    </div>
                </div>
